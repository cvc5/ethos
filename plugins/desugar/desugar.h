...
class Desugar : public StdPlugin
{
 ...
 private:
  ...
  /**
   * Parser-only metadata preserved for the Lean and Isabelle backends.
   * Desugaring removes constructor attributes from emitted declarations, so
   * this records the original surface syntax before that information is lost.
   */
