...
(define-fun $smtx_enum_type ((x1 tsm.Type) (x2 Int)) sm.Term
    (ite (= ($eo_type_enum (eo.SmtType x1) (eo.SmtTerm x2)) eo.Stuck) (sm.usort_value x1 x2) ($eo_type_enum (eo.SmtType x1) (eo.SmtTerm x2)))
)
