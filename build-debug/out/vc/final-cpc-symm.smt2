...
(declare-datatypes ((eo.Term 0) (vsm.Value 0) (msm.Map 0) (ssm.Seq 0))
  ...
  ; smt-cons: Rational
  (eo.Rational (eo.Rational.arg1 Real))
  ; smt-cons: String
...
(define-fun $eo_fail () eo.Term ($eo_fail_prog (eo.Boolean false)))
...
(define-fun $eo_true () eo.Term (eo.Boolean true))
(define-fun $eo_false () eo.Term (eo.Boolean false))
; program: $eo_bool
...
; program: $eo_z
(define-fun $eo_z ((x1 Int)) eo.Term
    (eo.Numeral x1)
)

; program: $eo_q
(define-fun $eo_q ((x1 Real)) eo.Term
    (eo.Rational x1)
)

; program: $eo_str
(define-fun $eo_str ((x1 String)) eo.Term
    (eo.String x1)
)
...
; program: $eo_mk_binary_w
(define-fun $eo_mk_binary_w ((x1 Int) (x2 Int)) eo.Term
...
(define-fun $eo_mk_binary ((x1 Int) (x2 Int)) eo.Term
  (ite false
    eo.Stuck
  (ite true
    (ite (<= 0 x1) (eo.Binary x1 (mod x2 ($smtx_pow2 x1))) eo.Stuck)
    eo.Stuck)))
...
(define-fun $smtx_is_atomic_term_value ((x1 eo.Term)) Bool
  ...
  (ite ((_ is eo.String) x1)
    true
  (ite ((_ is eo.Binary) x1)
    (and (<= 0 (eo.Binary.arg1 x1)) (= (eo.Binary (eo.Binary.arg1 x1) (eo.Binary.arg2 x1)) ($eo_mk_binary (eo.Binary.arg1 x1) (eo.Binary.arg2 x1))))
    false
))))))
