...
(declare-datatypes ((eo.new.Term 0) (vsm.new.Value 0) (@Map 0))
  ...
  (eo.new.$eo_Var (eo.new.$eo_Var.arg1 String) (eo.new.$eo_Var.arg2 tsm.new.Type))
  ; "stuckness"
  (eo.new.Stuck)
  ; user-decl: $eo_List
  (eo.new.$eo_List)
...
(declare-datatype eo.Term
  ...
  (eo.$eo_Var (eo.$eo_Var.arg1 eo.Term) (eo.$eo_Var.arg2 eo.Term))
