...
At present time, it is possible to provide the attribute `:type` to the definition, which instructs the checker to perform type checking on the given term (see [type checking define](#tcdefine)).
