 ...
 * ****************************************************************************
 *
 * alfc's exception base class and some associated utilities.
 */

#ifndef ALFC__EXCEPTION_H
#define ALFC__EXCEPTION_H
...
inline void CheckArgument(bool cond,
                          const T& arg [[maybe_unused]],
                          const char* tail [[maybe_unused]])
{
  if (__builtin_expect((!cond), false))
  {
    throw alfc::IllegalArgumentException("", "", tail);
  }
}
template <class T>
inline void CheckArgument(bool cond, const T& arg);
template <class T>
inline void CheckArgument(bool cond, const T& arg [[maybe_unused]])
{
  if (__builtin_expect((!cond), false))
  {
