...
`tools/eoc/compiler/sem_compile.py` compiles into them; the driver runs it before any
...
`tools/eoc/compiler/sem_target.py`, and this stage needs no change and no rebuild.
