...
(declare-datatypes
  ...
  (eo.DatatypeType (eo.DatatypeType.arg1 String) (eo.DatatypeType.arg2 edd.DatatypeDecl))
  ...
  ; smt-cons: DtCons
  (eo.DtCons (eo.DtCons.arg1 String) (eo.DtCons.arg2 edd.DatatypeDecl) (eo.DtCons.arg3 Nat))
  ; smt-cons: DtSel
  (eo.DtSel (eo.DtSel.arg1 String) (eo.DtSel.arg2 edd.DatatypeDecl) (eo.DtSel.arg3 Nat) (eo.DtSel.arg4 Nat))
  ; smt-cons: USort
  ...
  ; smt-cons: DtCons
  (vsm.DtCons (vsm.DtCons.arg1 String) (vsm.DtCons.arg2 dd.DatatypeDecl) (vsm.DtCons.arg3 Nat))
  ; smt-cons: Apply
  ...
  ; smt-cons: DtCons
  (sm.DtCons (sm.DtCons.arg1 String) (sm.DtCons.arg2 dd.DatatypeDecl) (sm.DtCons.arg3 Nat))
  ; smt-cons: DtSel
  (sm.DtSel (sm.DtSel.arg1 String) (sm.DtSel.arg2 dd.DatatypeDecl) (sm.DtSel.arg3 Nat) (sm.DtSel.arg4 Nat))
  ; smt-cons: DtTester
  (sm.DtTester (sm.DtTester.arg1 String) (sm.DtTester.arg2 dd.DatatypeDecl) (sm.DtTester.arg3 Nat))
  ; smt-cons: UConst
  ...
  (tsm.Char)
  ; smt-cons: Datatype
  (tsm.Datatype (tsm.Datatype.arg1 String) (tsm.Datatype.arg2 dd.DatatypeDecl))
  ; smt-cons: TypeRef
...
(declare-fun $smtx_dtc_resolve (dtc.DatatypeCons dd.DatatypeDecl) dtc.DatatypeCons)
(assert (! (forall ((x1 dtc.DatatypeCons) (x2 dd.DatatypeDecl))
...
(declare-fun $smtx_dt_resolve (dt.Datatype dd.DatatypeDecl) dt.Datatype)
(assert (! (forall ((x1 dt.Datatype) (x2 dd.DatatypeDecl))
...
(declare-fun $smtx_dd_lookup (String dd.DatatypeDecl) dt.Datatype)
(assert (! (forall ((x1 String) (x2 dd.DatatypeDecl))
...
(declare-fun $smtx_dd_has_dt (String dd.DatatypeDecl) Bool)
(assert (! (forall ((x1 String) (x2 dd.DatatypeDecl))
...
(declare-fun $smtx_dt_cons_wf_rec (dd.DatatypeDecl dtc.DatatypeCons) Bool)
(assert (! (forall ((x1 dd.DatatypeDecl) (x2 dtc.DatatypeCons))
...
(declare-fun $smtx_dt_wf_rec (dd.DatatypeDecl dt.Datatype) Bool)
(assert (! (forall ((x1 dd.DatatypeDecl) (x2 dt.Datatype))
...
(declare-fun $smtx_decl_wf_rec (dd.DatatypeDecl dd.DatatypeDecl) Bool)
(assert (! (forall ((x1 dd.DatatypeDecl) (x2 dd.DatatypeDecl))
...
(define-fun $smtx_ret_typeof_sel ((x1 String) (x2 dd.DatatypeDecl) (x3 Nat) (x4 Nat)) tsm.Type
...
(define-fun $smtx_model_eval_dt_sel ((x1 smm.SmtModel) (x2 String) (x3 dd.DatatypeDecl) (x4 Nat) (x5 Nat) (x6 vsm.Value)) vsm.Value
...
(define-fun $smtx_model_eval_dt_tester ((x1 String) (x2 dd.DatatypeDecl) (x3 Nat) (x4 vsm.Value)) vsm.Value
...
(declare-fun $eo_to_smt_datatype_decl (edd.DatatypeDecl) dd.DatatypeDecl)
(assert (! (forall ((x1 edd.DatatypeDecl))
